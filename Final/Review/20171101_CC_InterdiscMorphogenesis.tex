...
\subsubsection{Others}{Autres} \comment[CC]{c'est moche comme nom de section. Et on perd la logique de la structure du chapitre.}
...
\item \textbf{Symétrie} Des ruptures de symétrie occurrent \comment[CC]{anglicisme: se produisent}, majoritairement dans les étapes initiales, mais aussi à tous les stades de la morphogenèse.
...
Les intrications \comment[CC]{anglicisme: imbrications?} des relations entre agents, soit par des effets de voisinage comme des interactions mécaniques et la diffusion, ou par des interactions de réseaux comme le signalement, et la retroaction d'un flux d'information global (i.e. une causation descendante du niveau supérieur) apparaît être commun à la majorité des utilisations de la morphogenèse. Cela souligne la nature fondamentalement multi-niveaux des processus morphogénétiques et le rôle central de l'émergence.
}
...
\begin{equation}
\textrm{Self-organization} \supsetneq \textrm{Morphogenesis} \supsetneq \textrm{Autopoiesis} \supsetneq \textrm{Life} \comment[CC]{pourquoi en anglais?}
\end{equation}
...
<<<<<<< HEAD
Ce travail repose pour l'instant sur une revue large mais non \emph{systématique}, au sens de la méthodologie utilisée en évaluation thérapeutique par exemple, et où elle joue un rôle aussi important que les études primaires, une nouvelle connaissance étant crée \comment[CC]{créée} par la comparaison systématique des résultats et la meta-analyse. Cela impliquerait dans notre cas une approche multi-niveaux :\comment[FL]{pas le bon terme vu que tu parles par ailleurs de modeles multi-niveaux}
=======
