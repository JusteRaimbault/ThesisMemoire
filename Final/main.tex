...
%\include{Content/TransportationEquilibrium} % - ok text included
%
...
%
\ctparttext{\bpar{The buildings bricks, methods and tools are mainly set up for the culminating part of our work, which consists in the construction of models of co-evolution at different scales.}{À partir des fondations et des briques constitutives, cette partie introduit la construction de modèles de co-évolution pour les réseaux de transport et les territoires, à deux échelles ayant chacune leur paradigme propre.}}
%
...
%%%%%%%%%%%%%%%
% Old Chapter 8 : Empirical Opening
...
%\cleardoublepage
\include{FrontBackMatter/BackPage}
