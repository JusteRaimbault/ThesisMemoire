...
%\comment[FL]{Faire une carte.}[(JR) pas de données assez précises pour faire la carte équivalente à Paris, et je trouve peu d'intérêt à une carte juste de localisation et visualisation (je tiens à garder une densité de valeur ajoutée dans l'ensemble des figures)]
